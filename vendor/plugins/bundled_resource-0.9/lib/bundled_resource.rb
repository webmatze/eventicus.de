...
module BundledResource
  ...
  def uses_indicator_resources
    require_javascript "indicator"
  end

  def uses_stateful_form_resources
    require_javascript "stateful_form"
    require_dependency 'resource_extensions/stateful_form_extension'
    self.extend StatefulFormExtension
  end
end